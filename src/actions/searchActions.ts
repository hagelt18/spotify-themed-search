...
export const searchStart = (payload: SearchStartActionPayload): SearchStartAction => ({
  type: SEARCH_START,
  payload
});
...
export const searchComplete = (payload: SearchCompleteActionPayload): SearchCompleteAction => ({
...
export const setSelectedItem = (selectedItem: ResultItem): SetSelectedItemAction => ({
...
export const updateFilters = (filters: Partial<Filters>): UpdateFiltersAction => ({
  type: UPDATE_FILTERS,
  payload: { filters }
});
